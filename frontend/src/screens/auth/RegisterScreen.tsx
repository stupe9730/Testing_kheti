...
const RegisterScreen = () => {
  ...
  const { loading: sliceLoading, error, isAuthenticated } = useSelector((state: RootState) => state.auth);
  const loading = sliceLoading || apiLoading;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error(err.data?.error || 'Registration failed', { id: toastId });
    }
  };
