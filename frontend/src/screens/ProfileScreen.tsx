      ...
      <div className="space-y-3">
        ...
        <div className="bg-card border border-border rounded-3xl overflow-hidden">
          {[
            ...
            <button
              key={i}
              className="w-full p-4 flex items-center justify-between border-b border-border/50 last:border-0 hover:bg-muted/30 transition-colors"
            >
              <div className="flex items-center gap-3 text-muted-foreground">
                <div className="p-2.5 bg-muted rounded-xl">{item.icon}</div>
